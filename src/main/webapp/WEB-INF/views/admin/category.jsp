			...
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/category" method="POST" modelAttribute="category">
					<div class="form-group">
    					...
    					<div class="col-sm-10">
      						<form:input type="text" class="form-control" path="category" id="categoryId"/>
    					</div>
    					<label for="categoryId" class="col-sm-offset-2 col-sm-10"><form:errors path="category"/></label>
  					</div>
  					<div class="form-group">
			...
			<div class="col-md-6 col-xs-6 text-center">
				<div class="dropdown">
					...
					<ul class="dropdown-menu">
						<custom:sort innerHtml="Name asc" paramValue="category"/>
						<custom:sort innerHtml="Name desc" paramValue="category,desc"/>
					</ul>
				</div>
			</div>
			<div class="col-md-6 col-xs-6 text-center">
