		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/country">Country</a><span class="sr-only">(current)</span></li>
	...
	<div class="col-md-7 col-xs-12">
				...
				<form:form class="form-horizontal" action="/admin/country" method="POST" modelAttribute="country">
					<div class="form-group">
    					...
    					<div class="col-sm-10">
      						...
      						<form:input type="text" class="form-control" path="country" id="countryId"/>
    					</div>
		...
		<div class="row">
			...
			<c:forEach items="${page.content}" var="country">
				<div class="row">
					<div class="col-md-4 col-xs-4">${country.country}</div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-warning" href="/admin/country/update/${country.id}">update</a></div>
					<div class="col-md-4 col-xs-4"><a class="btn btn-danger" href="/admin/country/delete/${country.id}">delete</a></div>
				</div>
			</c:forEach>
	</div>
